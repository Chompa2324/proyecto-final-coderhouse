function ingresoPersona(nombre, apellido){
    let saludo = `Bienvenida a ShowroomFreyja ${nombre} ${apellido}. Aqui podras encontrar el oufit que siempre buscaste`;
    alert(saludo);
}

let nombrePer = prompt("ingresa tu nombre");
let apellidoPer = prompt("Ingrese su apellido");
ingresoPersona(nombrePer, apellidoPer);
